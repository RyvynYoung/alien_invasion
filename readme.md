Repo for game Alien Invasion project from book Python Crash Course by Eric Matthes
...
Learning Takeaways: making and using Classes, Pygame library, 

Debug solutions: File not found error, use full path for file